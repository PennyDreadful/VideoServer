...
public interface VideoSvcApi {
	...
	public static final String STAR_PARAMETER = "stars";

	public static final String ID_PARAMETER = "id";

	public static final String VIDEO_SVC_PATH = "/video";
	
	public static final String VIDEO_DATA_PATH = VIDEO_SVC_PATH + "/{id}/" + DATA_PARAMETER;
	
	public static final String VIDEO_STAR_PATH = VIDEO_SVC_PATH + "/{id}/{" + STAR_PARAMETER + "}";
	...
	/**
	 * This endpoint allows clients to add a rating for a particular video 
	 * 
	 * @return
	 */
	@POST(VIDEO_STAR_PATH)
	public Double addRating(@Path(ID_PARAMETER) long id, @Path(STAR_PARAMETER) int it);
